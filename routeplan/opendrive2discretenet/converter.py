...
class OpenDriveConverter:
    ...
    def create_parametric_lane(lane_borders, width, lane) -> ParametricLane:
        ...
        parametric_lane = ParametricLane(
            ...
            objects=lane.lane_section.parentRoad.objects,
            junction=lane.lane_section.parentRoad.junction,
            left_lanes=lane.lane_section.leftLanes,
            right_lanes=lane.lane_section.rightLanes,
            center_roadmark=lane.lane_section.center_roadmark
        )
