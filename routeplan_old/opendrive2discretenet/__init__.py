...
def main():
    ...
    print(road_info.discretelanes[0].getwidth)
    print(len(road_info.discretelanes[0].getwidth))
    print(len(road_info.discretelanes[0].left_vertices))


    # 打开并解析OpenDRIVE文件
    path = r"../changda_centerpoint.xodr"
    tree = ET.parse(path)
    root = tree.getroot()
    # 找到header元素
...
if __name__ == '__main__':
    main()
    # rosbag record /cicv_location /OdMap /test_trajectory_req -o OD
